    ...
    return (
        <main className="mx-auto flex min-h-dvh w-full max-w-3xl flex-col gap-7 px-5 pb-32 pt-10 sm:px-8 sm:pt-14">
            ...
            >
                ...
                <p className="text-[13px] text-muted">
                    Your todos live in this browser&rsquo;s local storage.
                    Export a JSON file periodically — if you clear browser data
                    or switch devices, you&rsquo;ll need it.
                </p>
                ...
                {importMessage && (
                    <p
                        ...
                        role={
                            importMessage.kind === "error" ? "alert" : "status"
                        }
                    >
                        {importMessage.text}
                    </p>
            ...
            >
                ...
                <p className="text-[13px] text-muted">
                    Removes every todo, label, and preference stored in this
                    browser. Export first if you want to keep them.
                </p>
                <div>
                    <button
